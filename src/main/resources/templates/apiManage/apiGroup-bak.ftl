	...
	<body>
		...
		<div class="weadmin-body">
			<div class="weadmin-block">
				...
				<button class="layui-btn" onclick="WeAdminShow('添加分类','apiManage/apiAdd')"><i class="layui-icon"></i>添加</button>
		...
		<script src="/apiManageJs/category.js" type="text/javascript" charset="utf-8"></script>
	</body>
