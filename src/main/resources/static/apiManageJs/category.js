	...
	},
	{
		...
		render: function(row) {
			return '<a onclick="member_stop(this,\'10001\')" href="javascript:;" title="启用"><i class="layui-icon">&#xe601;</i></a>' +
				'<a title="添加子类" onclick="WeAdminShow(\'添加\',add.ftl)" hreadd.ftlcript:;"><i class="layui-icon">&#xe654;</i></a>' +
				'<a title="编辑" onclick="WeAdminShow(\'编辑\',catecategory-edit.ftlef="javascript:;"><i class="layui-icon">&#xe642;</i></a>' +
